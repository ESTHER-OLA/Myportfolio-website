...
const Footer = () => {
  ...
  return (
    <div className="relative z-10 bg-dark bottom-0 w-full lg:flex lg:flex-row flex flex-col gap-4 lg:gap-[70rem] justify-center items-center text-white px-6 lg:py-3 py-2 ">
